...
public class SetuppageActivity extends Activity implements View.OnClickListener{
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        case R.id.menuCancelAnAlarm:
            ...
            case R.id.addMachine:
                ...
                intent.setClassName("com.somitsolutions.android.smsscheduler","com.somitsolutions.android.smsscheduler.AddMachineActivity");
    ...
    public void onBackPressed(){
    	...
    	//finish();
	    //Intent intent = new Intent(Intent.ACTION_MAIN);
		Intent intent = new Intent(SetuppageActivity.this,HomeActivity.class);
	    intent.addCategory(Intent.CATEGORY_HOME);
	    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
	   // intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
		...
		/*AlertDialog.Builder builder =
				new AlertDialog.Builder(SetuppageActivity.this);
		builder.setTitle("Best Wool Sweaters");
